...
- Exists: `modules/analysis/src/pss/pac.zig` (dense conversion matrix),
  `modules/solvers/src/freq_solve.zig` (stacked-real pattern trick, the
  $2n$ special case), `modules/solvers/src/direct.zig solveT`,
