...
impl Urc {
    ...
    fn resolve(params: &ParamMap) -> (f64, f64, f64, usize) {
        let r_per_len = params.get_or("r_per_len", params.get_or("ro", 1.0));
        let c_per_len = params.get_or("c_per_len", params.get_or("co", 1e-12));
        let length = params.get_or("length", params.get_or("l", 1.0));
...
impl DeviceModel for Urc {
    ...
    fn eval(&self, voltages: &[f64], params: &ParamMap) -> DeviceEval {
        ...
        DeviceEval {
            ...
            G: smallvec![(0, 0, g_tot), (0, 1, -g_tot), (1, 0, -g_tot), (1, 1, g_tot),],
