...
use crate::device::dispatch::DeviceDispatch;
...
use crate::device::{
    Bjt, Bsim3, CSwitch, Capacitor, Cccs, Ccvs, CurrentSource, Diode, Inductor, JfetLevel1, Mesfet,
    MosfetLevel1, Resistor, Switch, Vbic, Vccs, Vcvs, VoltageSource,
};
...
impl DeviceRegistry {
    ...
    pub fn new_default() -> Self {
        ...
        reg.register(
            DeviceKind::MosfetN,
            DeviceDispatch::MosfetLevel1(MosfetLevel1),
        );
        reg.register(
            DeviceKind::MosfetP,
            DeviceDispatch::MosfetLevel1(MosfetLevel1),
        ...
        reg.register(
            ...
            DeviceDispatch::VoltageSource(VoltageSource),
        );
        reg.register(
            DeviceKind::CurrentSource,
            DeviceDispatch::CurrentSource(CurrentSource),
        );
        ...
        reg.register(
            DeviceKind::BsourceV,
            DeviceDispatch::BsourceV(BsourceVModel),
        );
        reg.register(
            DeviceKind::BsourceI,
            DeviceDispatch::BsourceI(BsourceIModel),
        );
        ...
        reg.register(
            DeviceKind::Bsim4N,
            DeviceDispatch::Bsim4N(crate::Bsim4::nmos()),
        );
        reg.register(
            DeviceKind::Bsim4P,
            DeviceDispatch::Bsim4P(crate::Bsim4::pmos()),
        );
        ...
        reg.register(
            DeviceKind::MosfetN2,
            DeviceDispatch::MosfetLevel2(MosfetLevel2),
        );
        reg.register(
            DeviceKind::MosfetP2,
            DeviceDispatch::MosfetLevel2(MosfetLevel2),
        ...
        reg.register(
            DeviceKind::MosfetN3,
            DeviceDispatch::MosfetLevel3(MosfetLevel3),
        );
        reg.register(
            DeviceKind::MosfetP3,
            DeviceDispatch::MosfetLevel3(MosfetLevel3),
        ...
        reg.register(
            DeviceKind::MosfetN6,
            DeviceDispatch::MosfetLevel6(MosfetLevel6),
        );
        reg.register(
            DeviceKind::MosfetP6,
            DeviceDispatch::MosfetLevel6(MosfetLevel6),
        ...
        reg.register(
            DeviceKind::Wlossy,
            DeviceDispatch::Wlossy(WLossy::default()),
        );
    ...
    pub fn register(&mut self, kind: DeviceKind, model: DeviceDispatch) {
        ...
        debug_assert!(
            idx < MAX_DEVICE_KINDS,
            "DeviceKind discriminant {idx} exceeds registry capacity"
        );
...
mod tests {
    ...
    fn registry_num_terminals() {
        ...
        assert_eq!(
            reg.get(DeviceKind::VoltageSource).unwrap().num_terminals(),
            2
        );
        assert_eq!(
            reg.get(DeviceKind::CurrentSource).unwrap().num_terminals(),
            2
        );
