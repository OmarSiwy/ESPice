...
pub type OsdiEvalFn = unsafe extern "C" fn(handle: *mut c_void, sim_info: *mut OsdiSimInfo) -> u32;
...
pub type OsdiLoadNoiseFn = unsafe extern "C" fn(handle: *mut c_void, freq: f64, dst: *mut f64);
