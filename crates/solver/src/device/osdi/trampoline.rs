...
use super::abi::{OsdiDescriptor, OsdiNodePair, OsdiSimInfo, OsdiSimParas};
...
impl OsdiTrampoline {
    ...
    pub fn residual_iter<'a>(&'a self) -> impl Iterator<Item = (usize, f64)> + 'a {
        self.buffers.residual_resist.iter().copied().enumerate()
    }
}
...
#[cfg(test)]
#[allow(dead_code)]
pub(crate) unsafe fn handle_as_bytes(
