...
/// Strongly-typed builder/writer for rawfiles.
...
impl RawfileWriter {
    ...
    /// Create a writer that emits **ASCII** rawfile output.
    ...
    /// Provide column-major real data.
...
> {
    ...
    let num_points = num_points.ok_or_else(|| RawFileError::MissingField("No. Points".into()))?;
