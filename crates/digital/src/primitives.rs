...
use crate::state::{DigState, Level, Strength};
...
impl Primitive {
    ...
    pub fn new_dff(d: DigNodeIdx, clk: DigNodeIdx, q: DigNodeIdx, delay: f64, edge: EdgeKind) -> Self {
        Self {
    ...
    pub fn new_mux2(sel: DigNodeIdx, a: DigNodeIdx, b: DigNodeIdx, y: DigNodeIdx, delay: f64) -> Self {
        Self {
    ...
    pub fn new_mux4(s0: DigNodeIdx, s1: DigNodeIdx, a: DigNodeIdx, b: DigNodeIdx, c: DigNodeIdx, d: DigNodeIdx, y: DigNodeIdx, delay: f64) -> Self {
    ...
    pub fn new_demux2(sel: DigNodeIdx, data: DigNodeIdx, y0: DigNodeIdx, y1: DigNodeIdx, delay: f64) -> Self {
        Self {
    ...
    pub fn new_demux4(s0: DigNodeIdx, s1: DigNodeIdx, data: DigNodeIdx, ys: [DigNodeIdx; 4], delay: f64) -> Self {
...
impl PrimitiveBlock {
    ...
    pub fn eval(&mut self, id: usize, node_state: &[DigState]) -> SmallVec<[(DigNodeIdx, DigState); 4]> {
    ...
    pub fn tick_pulses(&mut self, t_now: f64, queue: &mut crate::event_queue::EventQueue) {
        for id in 0..self.kinds.len() {
            ...
            let next = if cur.is_one() { DigState::ZERO } else { DigState::ONE };
...
mod tests {
    ...
    fn pulse_tick_alternates() {
        ...
        let mut q = crate::event_queue::EventQueue::with_capacity(8);
