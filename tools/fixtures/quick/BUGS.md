...
### To reproduce
```bash
./target/release/incspice tests/fixtures/quick/rlc_underdamped_step.sp --quiet
...
### To verify
```bash
./target/release/incspice --output - tests/fixtures/quick/resistor_divider_dc_sweep.sp
