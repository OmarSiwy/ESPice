...
// ---------------------------------------------------------------------------
// GPU packing — one contiguous blob, offsets not pointers.
...
pub fn packForGpu(gpa: std.mem.Allocator, ckt: *const Circuit, tol: gpu_abi.Tol, n_blocks: u32, tp: TranPack) !GpuProblem {
